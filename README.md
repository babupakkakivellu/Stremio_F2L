...
| **`/link`** | Generates a **direct download link** for files sent to the bot (reply to file message). |
...
| **`FILE_TO_LINK_DUMP`** | **Telegram channel ID** where files sent via the File-to-Link feature are stored. Create a private channel and add your bot as admin. *Example: `-1001234567890`*. |
